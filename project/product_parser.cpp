...
{
    Product* maked=new Book(categoryID(),prodName_,price_,qty_,isbn_,author_);
    return maked;
}
...
{
    Product* maked = new Clothing(categoryID(), prodName_,price_,qty_,size_,brand_);
    return maked;
}
...
{
    Product* maked=new Movie(categoryID(),prodName_,price_,qty_,genre_,rating_);
    return maked;
